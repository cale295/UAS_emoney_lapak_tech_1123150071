...
///   techpay://pay?merchant_id=...&merchant_name=...&amount=...
///                      &description=...&reference=...&callback=...
///   https://techpay.app/pay?merchant_id=...&...  (App Link, opsional)
@immutable
...
class DeeplinkService {
  ...
  bool _isPaymentLink(Uri uri) {
    if (uri.scheme == 'techpay' && uri.host == 'pay') return true;
    if (uri.scheme == 'https' &&
        uri.host == 'techpay.app' &&
